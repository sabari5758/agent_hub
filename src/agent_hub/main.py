...
def run():
    ...
    try:
        AgentHub().crew().kickoff(inputs=inputs)
...
def replay():
    ...
    """
    try:
        AgentHub().crew().replay(task_id=sys.argv[1])
...
def test():
    ...
    try:
        AgentHub().crew().test(n_iterations=int(sys.argv[1]), eval_llm=sys.argv[2], inputs=inputs)
...
def run_with_trigger():
    ...
    try:
        result = AgentHub().crew().kickoff(inputs=inputs)
        return result
    except Exception as e:
